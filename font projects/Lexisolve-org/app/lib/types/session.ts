...
export interface FontParameters {
  /** Letter spacing: -1 = 0%, +1 = +12% */
  letterSpacing: -1 | 1;
  /** Word spacing: -1 = 0%, +1 = +20% */
  wordSpacing: -1 | 1;
  /** Line height: -1 = 1.4, +1 = 1.8 */
  lineHeight: -1 | 1;
  /** Font weight: -1 = 400, +1 = 600 */
  fontWeight: -1 | 1;
  /** Font size adjustment: -1 = 0%, +1 = +15% */
  fontSize: -1 | 1;
  /** Paragraph width: -1 = 65ch, +1 = 50ch */
  paragraphWidth: -1 | 1;
...
export function parametersToCSSValues(params: FontParameters): CSSFontValues {
  ...
  return {
    letterSpacing: params.letterSpacing === 1 ? '0.12em' : '0em',
    wordSpacing: params.wordSpacing === 1 ? '0.2em' : '0em',
    lineHeight: params.lineHeight === 1 ? 1.8 : 1.4,
    fontWeight: params.fontWeight === 1 ? 600 : 400,
    fontSize: params.fontSize === 1 ? '1.15em' : '1em',
    maxWidth: params.paragraphWidth === 1 ? '50ch' : '65ch',
